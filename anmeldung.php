        ...
        <form class="validate-form" action="<?= dirname($_SERVER['PHP_SELF']) ?>/include/action_page.php" method="post">
            ...
            <div class="contact-form ">
                ...
                <div class="wrap-input">
                    ...
                    <div class="question-answer question input validate-input " data-validate="fehlt">
                        <input type="radio" class="input" value="international" id="international"
                               name="international"/>
                ...
                <div class="wrap-input">
                    ...
                    <textarea class="input" name="message"
                              placeholder="(bspw. Wunschpartner, weitere Informationen,...)"></textarea>
                    <span class="focus-input"></span>
                </div>
            ...
            <div class="wide-check">
                <div class="question-answer question input validate-input " data-validate="fehlt">
                    ...
                    <label for="datenschutz" class="check"><span class="check">Hiermit bestätige ich die Richtigkeit meiner Angaben und stimme der Speicherung dieser zu (Siehe <a
                                    href="https://fachschaft.physik.kit.edu/drupal/content/datenschutzerklärung">Datenschutz</a>)</span></label>
                </div>
                <span class="focus-input"></span>
