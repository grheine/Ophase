...
<div class="tab">
  <button class="tablinks" onclick="openCity(event, 'Montag')" id="defaultOpen"><h2>Montag</h2></button>
  <button class="tablinks" onclick="openCity(event, 'Dienstag')"><h2>Dienstag</h2></button>
  <button class="tablinks" onclick="openCity(event, 'Mittwoch')"><h2>Mittwoch</h2></button>
  <button class="tablinks" onclick="openCity(event, 'Donnerstag')"><h2>Donnerstag</h2></button>
  <button class="tablinks" onclick="openCity(event, 'Freitag')" ><h2>Freitag</h2></button>
</div>
