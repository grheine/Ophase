...
<html lang="en">
<head>
    <title>FAQ - O-Phase WS20/21</title>
    <meta charset="UTF-8">
...
<div class="wrap-contact">
  <div class="contact-form-title" style="background-image: url(images/bg-01.jpg);">
        <ul class="topnav">
          ...
          <li><a class="active" href="<?= dirname($_SERVER['PHP_SELF'])?>/faq">FAQ</a></li>
...
<div class="wide faq">
    ...
    <h2>Corona</h2>
    <h3>O-Phase – geht das überhaupt?</h3>
    ...
    <h3>Hilfe, ich habe noch keine Wohnung!1!!</h3>
    ...
    <h3>Wie muss ich mich für das Studium bewerben?</h3>
    ...
    <h3>Wie kann ich mich sonst auf das Studium vorbereiten?</h3>
    ...
    <h3>Ich will zusätzlich zu meinem Studiengang noch Mathematik/Informatik/E-Tech studieren. Geht das?</h3>
    ...
    <h2>Technisches</h2>
    <h3>Wo bekomme ich einen Internetzugang/Account/etc.?</h3>
    ...
    <h3>Kann man in Karlsruhe gut abends weggehen?</h3>
    ...
    <h3>Wie wohnen Studierende in Karlsruhe?</h3>
    <p>Die meisten Studierenden wohnen in Wohngemeinschaften (WGs) oder im Wohnheim. Davon gibt es in Karlsruhe einige. Zimmer vermittelt unter anderem das Studierendenwerk; einige Wohnheime sind auch selbstverwaltet. Sowohl die Wohnheime als auch die Privatwohnungen liegen meist nicht mehr als zehn Minuten (mit dem Fahrrad) von der Uni entfernt. Besonders herauszustellen ist hierbei das <a target="_blank" href="https://www.hadiko.de">HaDiKo</a> – das größte selbstverwaltete Studentenwohnheim Deutschlands. </p>
    <h3>Ich suche eine (provisionsfreie) Wohnung, oder eine WG, wo suche ich am besten?</h3>
    ...
    <h3>Ich wohne ganz in der Nähe, kann ich zu Hause bleiben?</h3>
