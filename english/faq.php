...
<div class="wide faq">
 ...
 ?>
    ...
    <p> On our Discord Server we have already created various rooms that you can join. It is best to download the Discord program before the O-Phase, as it runs more smoothly than the web app. You can find the download link <a href="https://discord.com/download"> here </a>. It is best to get to grips with the program before using it for the first time in the O-Phase, as it is sometimes not entirely intuitive. <br>
